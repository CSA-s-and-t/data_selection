...
augment_to_command = {
    'vmifgsm_3': 'cd ../augmentation/TransferAttack && C:\\Users\\silas\\Anaconda3\\Scripts\\activate.bat transferattack && python -u main.py \
        --input_dir {directory} --output_dir {results} --attack vmifgsm --model xception --eps 3 --batchsize 8',
    'vmifgsm_6': 'cd ../augmentation/TransferAttack && C:\\Users\\silas\\Anaconda3\\Scripts\\activate.bat transferattack && python -u main.py \
        --input_dir {directory} --output_dir {results} --attack vmifgsm --model xception --eps 6 --batchsize 8',
    ...
    'gra_6': 'cd ../augmentation/TransferAttack && C:\\Users\\silas\\Anaconda3\\Scripts\\activate.bat transferattack && python -u main.py \
        --input_dir {directory} --output_dir {results} --attack gra --model xception --eps 6 --batchsize 8',
    ...
    'ncs_6': 'cd ../augmentation/TransferAttack && C:\\Users\\silas\\Anaconda3\\Scripts\\activate.bat transferattack && python -u main.py \
        --input_dir {directory} --output_dir {results} --attack ncs --model xception --eps 6 --batchsize 8',
    ...
    'dem_6': 'cd ../augmentation/TransferAttack && C:\\Users\\silas\\Anaconda3\\Scripts\\activate.bat transferattack && python -u main.py \
        --input_dir {directory} --output_dir {results} --attack dem --model xception --eps 6 --batchsize 4',
    'decowa_3': 'cd ../augmentation/TransferAttack && C:\\Users\\silas\\Anaconda3\\Scripts\\activate.bat transferattack && python -u main.py \
        --input_dir {directory} --output_dir {results} --attack decowa --model xception --eps 3 --batchsize 4',
    'decowa_6': 'cd ../augmentation/TransferAttack && C:\\Users\\silas\\Anaconda3\\Scripts\\activate.bat transferattack && python -u main.py \
        --input_dir {directory} --output_dir {results} --attack decowa --model xception --eps 6 --batchsize 4',
}   
